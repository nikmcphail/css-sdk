...
#define JOYSTICK_BUTTON(_joystick, _button)                                                    \
  ((button_code_e)JOYSTICK_BUTTON_INTERNAL(_joystick, _button))
#define JOYSTICK_POV_BUTTON(_joystick, _button)                                                \
  ((button_code_e)JOYSTICK_POV_BUTTON_INTERNAL(_joystick, _button))
#define JOYSTICK_AXIS_BUTTON(_joystick, _button)                                               \
  ((button_code_e)JOYSTICK_AXIS_BUTTON_INTERNAL(_joystick, _button))
...
#define STEAMCONTROLLER_AXIS_BUTTON_INTERNAL(_joystick, _button)                               \
  (STEAMCONTROLLER_FIRST_AXIS_BUTTON + ((_joystick) * STEAMCONTROLLER_AXIS_BUTTON_COUNT) +     \
   (_button))
#define STEAMCONTROLLER_BUTTON(_joystick, _button)                                             \
  ((button_code_e)STEAMCONTROLLER_BUTTON_INTERNAL(_joystick, _button))
#define STEAMCONTROLLER_AXIS_BUTTON(_joystick, _button)                                        \
  ((button_code_e)STEAMCONTROLLER_AXIS_BUTTON_INTERNAL(_joystick, _button))
...
enum button_code_e {
  ...
  STEAMCONTROLLER_LAST_BUTTON  = STEAMCONTROLLER_BUTTON_INTERNAL(
      MAX_STEAM_CONTROLLERS - 1, STEAMCONTROLLER_MAX_BUTTON_COUNT - 1),
  STEAMCONTROLLER_FIRST_AXIS_BUTTON,
  STEAMCONTROLLER_LAST_AXIS_BUTTON = STEAMCONTROLLER_AXIS_BUTTON_INTERNAL(
